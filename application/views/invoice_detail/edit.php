    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Invoice Detail Edit</h3>
            </div>
			<?php echo form_open('invoice_detail/edit/'.$invoice_detail['id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_invoice" class="form-control">
								...
								{
									$selected = ($invoice['id'] == $invoice_detail['id_invoice']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_product" class="form-control">
								...
								{
									$selected = ($product['id'] == $invoice_detail['id_product']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="name_product" value="<?php echo ($this->input->post('name_product') ? $this->input->post('name_product') : $invoice_detail['name_product']); ?>" class="form-control" id="name_product" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="amount" class="control-label">Amount</label>
						<div class="form-group">
							<input type="text" name="amount" value="<?php echo ($this->input->post('amount') ? $this->input->post('amount') : $invoice_detail['amount']); ?>" class="form-control" id="amount" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="price" class="control-label">Price</label>
						<div class="form-group">
							<input type="text" name="price" value="<?php echo ($this->input->post('price') ? $this->input->post('price') : $invoice_detail['price']); ?>" class="form-control" id="price" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="discount" class="control-label">Discount</label>
						<div class="form-group">
							<input type="text" name="discount" value="<?php echo ($this->input->post('discount') ? $this->input->post('discount') : $invoice_detail['discount']); ?>" class="form-control" id="discount" />
						</div>
					</div>
					<div class="col-md-6">
