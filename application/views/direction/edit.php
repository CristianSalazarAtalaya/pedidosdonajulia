			...
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_user" class="form-control">
								...
								{
									$selected = ($user['id'] == $direction['id_user']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="date_created" value="<?php echo ($this->input->post('date_created') ? $this->input->post('date_created') : $direction['date_created']); ?>" class="has-datetimepicker form-control" id="date_created" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="date_updated" class="control-label">Date Updated</label>
						<div class="form-group">
							<input type="text" name="date_updated" value="<?php echo ($this->input->post('date_updated') ? $this->input->post('date_updated') : $direction['date_updated']); ?>" class="form-control" id="date_updated" />
						</div>
					</div>
				</div>
			</div>
